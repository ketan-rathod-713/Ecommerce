...
const Checkout = () => {
  ...
  const handleOrder = (e)=>{
    const order = {
      ...
      paymentMethod,
      selectedAddress,
      status: "pending" // admin can change it. delivered, recieved etc.
    };
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 lg:gap-x-8 gap-y-10 lg:grid-cols-5 mt-12 mb-12">
    <div className="lg:col-span-3 sm:col-span-1">
    <form action="" className="bg-white px-5 py-5" noValidate onSubmit={handleSubmit((data)=>{
      ...
      {user.addresses.map((address, index) => (
        <li key={address.index} className="flex justify-between gap-x-6 py-5 px-7">
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-500">{address.phone}</p>
          ...
          <div>
            <fieldset>
              <legend className="text-left text-sm font-semibold leading-6 text-gray-900">Payments Method</legend>
    ...
    <div className="mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-2">
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 mb-10 mt-5">
            Cart
          </h1>
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                      <div className="text-gray-500">
                        ...
                        <select onChange={(e) => handleQuantity(e, item)} name="" id="" value={item.quantity}>
                        ...
                        {/* This can also be governed from server */}
